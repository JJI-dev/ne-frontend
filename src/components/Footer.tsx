...
export default function Footer() {
  return (
    <footer style={{ background: 'var(--white)' }}>
      ...
      {/* 워드마크 — overflow hidden으로 clip, height 고정으로 공백 제거 */}
      <div style={{ overflow: 'hidden', height: 'var(--footer-clip-h, clamp(60px,7vw,130px))', display: 'block' }}>
        <svg
          viewBox="0 0 1920 300"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          preserveAspectRatio="xMidYMid slice"
          style={{ display: 'block', width: '100%', height: '200%', transform: 'translateY(var(--footer-clip-ty,-10%))' }}
        >
